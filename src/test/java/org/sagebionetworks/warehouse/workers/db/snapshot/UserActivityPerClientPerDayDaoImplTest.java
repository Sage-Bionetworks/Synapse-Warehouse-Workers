...
public class UserActivityPerClientPerDayDaoImplTest {
	...
	public void testCreateUpdate() {
		...
		UserActivityPerClientPerDay actualUar1 = dao.get(uar1.getUserId(), uar1.getXForwardedFor(), uar1.getDate(), uar1.getClient());
		UserActivityPerClientPerDay actualUar2 = dao.get(uar2.getUserId(), uar2.getXForwardedFor(), uar2.getDate(), uar2.getClient());
		...
		actualUar2 = dao.get(uar2.getUserId(), uar2.getXForwardedFor(), uar2.getDate(), uar2.getClient());
		assertEquals(uar2, actualUar2);
		...
		UserActivityPerClientPerDay actualUar3 = dao.get(uar3.getUserId(), uar3.getXForwardedFor(), uar3.getDate(), uar3.getClient());
	...
	public void testGetUserActivityPerMonth(){
		...
		UserActivityPerClientPerDay uar1 = createUserActivityPerClientPerDay(1L, "1.2.3.4", "2016-01-13", Client.R);
		UserActivityPerClientPerDay uar2 = createUserActivityPerClientPerDay(1L, "1.2.3.4", "2016-01-02", Client.R);
		// user with 2 clients
		UserActivityPerClientPerDay uar3 = createUserActivityPerClientPerDay(2L, "1.2.3.4", "2016-01-08", Client.R);
		UserActivityPerClientPerDay uar4 = createUserActivityPerClientPerDay(2L, "1.2.3.4", "2016-01-08", Client.JAVA);
		// user with 2 activity on the same date, same client
		UserActivityPerClientPerDay uar5 = createUserActivityPerClientPerDay(3L, "1.2.3.4", "2016-01-14", Client.R);
		UserActivityPerClientPerDay uar6 = createUserActivityPerClientPerDay(3L, "1.2.3.4", "2016-01-14", Client.R);
		...
		UserActivityPerMonth ua1 = createUserActivityPerMonth(1L, "1.2.3.4", "2016-01-01", 2L);
		UserActivityPerMonth ua2 = createUserActivityPerMonth(2L, "1.2.3.4", "2016-01-01", 1L);
		UserActivityPerMonth ua3 = createUserActivityPerMonth(3L, "1.2.3.4", "2016-01-01", 1L);
	...
	private UserActivityPerMonth createUserActivityPerMonth(long userId, String xForwardedFor, String month, long uniqueDate) {
		...
		ua.setUserId(userId);
		ua.setXForwardedFor(xForwardedFor);
		ua.setMonth(month);
		ua.setUniqueDate(uniqueDate);
		return ua;
	}

	private UserActivityPerClientPerDay createUserActivityPerClientPerDay(Long userId, String xForwardedFor, String date, Client client) {
		UserActivityPerClientPerDay uar = new UserActivityPerClientPerDay();
		uar.setClient(client);
		uar.setUserId(userId);
		uar.setDate(date);
		uar.setXForwardedFor(xForwardedFor);
		return uar;
	}
}
