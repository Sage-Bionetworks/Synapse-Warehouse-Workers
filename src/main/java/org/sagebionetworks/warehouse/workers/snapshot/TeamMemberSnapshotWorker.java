...
public class TeamMemberSnapshotWorker extends AbstractSnapshotWorker<ObjectRecord, TeamMemberSnapshot> implements SnapshotWorker<ObjectRecord, TeamMemberSnapshot> {
