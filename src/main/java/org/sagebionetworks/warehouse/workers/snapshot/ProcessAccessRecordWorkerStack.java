...
public class ProcessAccessRecordWorkerStack implements WorkerStackConfigurationProvider {

	final WorkerStackConfiguration config;

	@Inject
	public ProcessAccessRecordWorkerStack (CountingSemaphore semaphore,
