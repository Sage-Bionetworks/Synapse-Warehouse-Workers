...
public class Sql {
	...
	public static final String COL_VERIFICATION_SUBMISSION_RECORD_STATE_ID = "ID";
	public static final String COL_VERIFICATION_SUBMISSION_RECORD_STATE_STATE = "STATE";
	public static final String COL_VERIFICATION_SUBMISSION_RECORD_STATE_CREATED_ON = "CREATED_ON";
	public static final String COL_VERIFICATION_SUBMISSION_RECORD_STATE_CREATED_BY = "CREATED_BY";
}
