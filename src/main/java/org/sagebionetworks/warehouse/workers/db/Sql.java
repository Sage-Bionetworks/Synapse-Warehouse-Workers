...
public class Sql {
	...
	public static final String COL_PROCESSED_ACCESS_RECORD_CLIENT_VERSION = 				"CLIENT_VERSION";
	...
	public static final String COL_USER_ACTIVITY_PER_CLIENT_PER_DAY_XFORWARDEDFOR = "X_FORWARDED_FOR";
	...
	public static final String COL_USER_ACTIVITY_PER_MONTH_XFORWARDEDFOR = "X_FORWARDED_FOR";
	...
	// FILE_HANDLE_COPY_RECORD
	public static final String TABLE_FILE_HANDLE_COPY_RECORD = "FILE_HANDLE_COPY_RECORD";
	public static final String COL_FILE_HANDLE_COPY_RECORD_TIMESTAMP = "TIMESTAMP";
	public static final String COL_FILE_HANDLE_COPY_RECORD_USER_ID = "USER_ID";
	public static final String COL_FILE_HANDLE_COPY_RECORD_ORIGINAL_FILE_HANDLE_ID = "ORIGINAL_FILE_HANDLE_ID";
	public static final String COL_FILE_HANDLE_COPY_RECORD_ASSOCIATION_OBJECT_ID = "ASSOCIATION_OBJECT_ID";
	public static final String COL_FILE_HANDLE_COPY_RECORD_ASSOCIATION_OBJECT_TYPE = "ASSOCIATION_OBJECT_TYPE";
	public static final String COL_FILE_HANDLE_COPY_RECORD_NEW_FILE_HANDLE_ID = "NEW_FILE_HANDLE_ID";
}
